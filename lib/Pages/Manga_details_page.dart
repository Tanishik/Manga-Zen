                 ...
                 children: [    
                    SizedBox(
                      ...
                      child: ImageFiltered(
                        ...
                        child: Image.network(widget.mangaId.image,
                        fit: BoxFit.cover,
                        ),
                      ),
                    ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                const Icon(Icons.person_2_outlined, color: Colors.white54),
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        const Text('Library', style: TextStyle(color: Colors.white54, fontSize: 14,fontFamily: 'Montserrat',)),
                      ],
                    ),
                    ...
                    Column(
                      children: [
                        IconButton(
                          icon: const Icon(Icons.hourglass_empty, color: Colors.white54, size: 25),
                          onPressed: () {},
                        ),
                        const Text('Soon', style: TextStyle(color: Colors.white54, fontSize: 14,fontFamily: 'Montserrat',)),
                      ],
                    ),
                    Column(
                      children: [
                        IconButton(
                          icon: const Icon(Icons.sync, color: Colors.white54, size: 25),
                          onPressed: () {},
                        ),
                        const Text('Tracking', style: TextStyle(color: Colors.white54, fontSize: 14,fontFamily: 'Montserrat',)),
                      ],
                    ),
                    Column(
                      children: [
                        IconButton(
                          icon: const Icon(Icons.web, color: Colors.white54, size: 25),
                          onPressed: () {},
                        ),
                        const Text('WebView', style: TextStyle(color: Colors.white54, fontSize: 14,fontFamily: 'Montserrat',)),
                      ],
                    ),
                  ],
                ),
                ...
                chapters.isEmpty
                  ?
                     Center(child: Padding(
                       ...
                       child: Text('No Chapters yet.',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,fontSize: 20,fontFamily: 'Montserrat',),),
                     ))
                  ...
                  : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      readBox.put(_chapter.id, _chapter.id);
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (_) => ReaderPage(
